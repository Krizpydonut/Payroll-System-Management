            ...
            result.data.forEach(emp => {
                ...
                tr.innerHTML = `
                    ...
                    <td style="text-align: right;">
                        <button class="btn-outline" style="border-color:var(--green); color:var(--green); padding:4px 8px; font-size:11px;" onclick="restoreSingle(${emp.employee_id})">Restore</button>
                    </td>
                `;
...
async function restoreSingle(id) {
    if(confirm("Restore this employee?")) executeAction('restore', [id]);
}
